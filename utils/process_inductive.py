...
def load_ppi(dataset):
    print ('Loading G...')
    with open('data_{}/{}-G.json'.format(dataset, dataset)) as jsonfile:
    ...
    with open('data_{}/{}-id_map.json'.format(dataset, dataset)) as jsonfile:
    ...
    features_=np.load('data_{}/{}-feats.npy'.format(dataset, dataset))
